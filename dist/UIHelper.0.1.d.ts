...
declare namespace JS {
    interface IJavaScriptParseXState extends IJavaScriptParseState {
        endStatementBy: "{" | ";" | "<" | "," | "@" | "\n" | "\r" | "";
    }
    abstract class ParserX extends Parser {
        static keyWord(m: IJavaScriptParseXState): void;
        static getInitData(condition: string, start?: number): IJavaScriptParseXState;
...
declare namespace UIHelper {
    ...
    function getViewPropertyInfoString(topsType: string[]): string;
    function getViewInitDOMString(topsJS: string[]): string;
}
interface IRefs {
    name: string;
 ...
 * 加载UI
 */
declare function renderVMComponent(this: void, node: VMDOM.VHTMLUnknownElement, uiInfo: string | {
    sortPath: string;
    name: string;
}, scripts: (VMDOM.VScript & IVNodeMethod)[]): void;
declare namespace UIHelper {
    /**生成Class.ts代码文件 */
